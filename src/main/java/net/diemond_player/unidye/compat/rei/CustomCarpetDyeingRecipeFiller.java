...
//
//public class CustomCarpetDyeingRecipeFiller implements CraftingRecipeFiller<CustomCarpetDyeingRecipe> {
//    @Override
//    public Collection<Display> apply(RecipeEntry<CustomCarpetDyeingRecipe> recipe) {
...
//            for (int k = 0; k < 9; k++) {
//                if (k != 4) {
//                    inputs.add(EntryIngredients.ofItemTag(ItemTags.WOOL_CARPETS));
//                } else {
...
//
//    @Override
//    public Class<CustomCarpetDyeingRecipe> getRecipeClass() {
//        return CustomCarpetDyeingRecipe.class;
//    }
//}
