...
public class EmiCustomCarpetRecipe extends EmiPatternCraftingRecipe {
    ...
    public EmiCustomCarpetRecipe(Identifier id) {
        super(List.of(EmiStack.of(UnidyeBlocks.CUSTOM_WOOL)), EmiStack.of(UnidyeBlocks.CUSTOM_CARPET), id, false);
    }
    ...
    public SlotWidget getOutputWidget(int x, int y) {
        return new GeneratedSlotWidget(r -> {
            ItemStack itemStack = UnidyeUtils.blendAndSetColor(new ItemStack(UnidyeBlocks.CUSTOM_CARPET), getDyes(r), Lists.newArrayList());
