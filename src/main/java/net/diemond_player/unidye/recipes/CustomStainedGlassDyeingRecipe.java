...
public class CustomStainedGlassDyeingRecipe extends SpecialCraftingRecipe {
    ...
    public boolean matches(CraftingRecipeInput inventory, World world) {
        ...
        for (int i = 0; i < inventory.getSize(); i++) {
            ...
            if ((itemStack2.isIn(net.fabricmc.fabric.api.tag.convention.v2.ConventionalItemTags.GLASS_BLOCKS) && i != 4)
    ...
    public ItemStack craft(CraftingRecipeInput inventory, RegistryWrapper.WrapperLookup lookup) {
        ...
        UnidyeUtils.setColor(itemStack1, CustomDyeItem.getMaterialColor(inventory.getStackInSlot(4), "glass"));
    ...
    public RecipeSerializer<?> getSerializer() {
        return UnidyeSpecialRecipes.CUSTOM_STAINED_GLASS_DYEING;
    }
}
