...
public class DyeableFallingBlockEntity extends FallingBlockEntity {
    ...
    public static DyeableFallingBlockEntity spawnFromBlock(World world, BlockPos pos, BlockState state) {
        DyeableFallingBlockEntity fallingBlockEntity = new DyeableFallingBlockEntity(world, (double) pos.getX() + 0.5, pos.getY() + 1, (double) pos.getZ() + 0.5, state.contains(Properties.WATERLOGGED) ? state.with(Properties.WATERLOGGED, false) : state);
                        ...
                        if (bl3 && bl5) {
                            ...
                            if (this.getWorld().setBlockState(blockPos.down(2), this.block, Block.NOTIFY_ALL)) {
                                ...
                                if (block instanceof LandingBlock) {
                                    ((LandingBlock) block).onLanding(this.getWorld(), blockPos.down(2), this.block, blockState, this);
